...
function pro_tree { local tree="$1"; workspace="$PROJECTS/trees" pro "${tree%/}"; }
alias tree='pro_tree' tre='pro_tree'
...
if [[ "$whereami" == 'android' ]]; then
  ...
  # alias coreaudioglitch='sudo pkill coreaudiod bluetoothd'
