$clientPath = Join-Path $HOME "Riot Games\Riot Client\RiotClientServices.exe"

if (!(Test-Path "$clientPath")) {
  Write-Host "[!] Riot Client not found at: $clientPath. Use `pax i riot`." -ForegroundColor Red
  exit
}
