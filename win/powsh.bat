...
:elevate
powershell -Command "Start-Process powershell -ArgumentList '-NoProfile -ExecutionPolicy Bypass -NoExit -Command \"%LOAD_CMD%; %args_list%; Read-Host `\"Ciao!`\"\"' -Verb RunAs"
goto :eof
