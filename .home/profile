...
alias lmsup='curl -fsSL https://lmstudio.ai/install.sh | bash;'
alias lmsmodels='lms get qwen/qwen3-8b; lms get mistralai/devstral-small-2507;lms get google/gemma-3-1b;'
